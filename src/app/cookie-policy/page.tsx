    ...
    <main className="pt-28 sm:pt-32 pb-20 sm:pb-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass rounded-2xl p-5 sm:p-8 lg:p-12 space-y-10 sm:space-y-12 animate-slide-up">
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Que Sont les Cookies ?</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Comment Nous Utilisons les Cookies</h2>
            ...
            <div className="grid gap-4">
              {[
                ...
                <div key={index} className="p-4 rounded-xl bg-white/5 border border-white/10">
                  <h3 className="text-white font-bold mb-1">{cookie.title}</h3>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Gérer les Cookies</h2>
            <p className="text-slate-300 leading-relaxed">
