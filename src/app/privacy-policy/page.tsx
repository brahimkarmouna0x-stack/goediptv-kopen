    ...
    <main className="pt-28 sm:pt-32 pb-20 sm:pb-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass rounded-2xl p-5 sm:p-8 lg:p-12 space-y-10 sm:space-y-12 animate-slide-up">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Informations Que Nous Collectons</h2>
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                <h3 className="text-[#3B82F6] font-bold mb-2">Données Personnelles</h3>
              ...
              <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                <h3 className="text-[#EF4135] font-bold mb-2">Données d'Utilisation</h3>
                <p className="text-slate-400 text-sm">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Comment Nous Utilisons Vos Données</h2>
            <ul className="space-y-4">
              {[
                ...
                <li key={index} className="flex gap-3 text-slate-300">
                  <CheckCircle2
                    className="mt-1 h-5 w-5 shrink-0 text-[#3B82F6]"
                    aria-hidden="true"
                  />
                  <span>{item}</span>
                </li>
          ...
          <section className="pt-8 border-t border-white/10 text-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-linear-to-r from-[#0055A4] to-[#EF4135] text-white font-bold hover:shadow-lg hover:shadow-[#0055A4]/35 transition-all glow-blue"
            >
